...
import 'package:ikhdemny/model/foodModels/shawrmaModel.dart';
import 'package:ikhdemny/view/foodScreen/main_food_screen.dart';

import '../../../../../widgets/horizontal_listview.dart';

class ShawermaMenuScreen extends StatefulWidget {
  ...
  @override
  _ShawermaMenuScreenState createState() => _ShawermaMenuScreenState();
}

class _ShawermaMenuScreenState extends State<ShawermaMenuScreen> {
  @override
            ...
            child: SizedBox(
              ...
              child: ListView.separated(
                itemBuilder: (context, index) {
                  ...
                  ShawermaModel kfcList = shawermaMenuList[index];
                ...
                itemCount: shawermaMenuList.length,
              ),
            ),
          ),
        ],
