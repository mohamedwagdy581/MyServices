...
class PlumberCategoryScreen extends StatefulWidget {
  const PlumberCategoryScreen({Key? key}) : super(key: key);

  @override
  _PlumberCategoryScreenState createState() => _PlumberCategoryScreenState();
}

class _PlumberCategoryScreenState extends State<PlumberCategoryScreen> {
  var productsList = plumberCategoryList;
