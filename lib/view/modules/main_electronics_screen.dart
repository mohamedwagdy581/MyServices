...
class ElectronicsCategoryScreen extends StatefulWidget {
  const ElectronicsCategoryScreen({Key? key}) : super(key: key);

  @override
  _ElectronicsCategoryScreenState createState() =>
      _ElectronicsCategoryScreenState();
}

class _ElectronicsCategoryScreenState extends State<ElectronicsCategoryScreen> {
  var productsList = electronicsCategoryList;
