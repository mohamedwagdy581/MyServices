...
import 'package:ikhdemny/model/foodModels/tazajModel.dart';
import 'package:ikhdemny/view/foodScreen/main_food_screen.dart';

import '../../../widgets/horizontal_listview.dart';

class TazajMenuScreen extends StatefulWidget {
  ...
  @override
  _TazajMenuScreenState createState() => _TazajMenuScreenState();
}

class _TazajMenuScreenState extends State<TazajMenuScreen> {
            ...
            child: SizedBox(
              ...
              child: ListView.separated(
                itemBuilder: (context, index) {
                  ...
                  TazajModel kfcList = tazajMenuList[index];
